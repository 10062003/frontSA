...
const SeleccionConValidacion = ({
  ...
  return (
    <div>
      <label
        htmlFor={name}
        className={`block text-base font-bold p-1 ml-4 min-h-2.5 cursor-pointer dark:text-white ${classNamelabel} ${estado.valido === "true" ? "text-exito" : ""} ${estado.valido === "false" ? "text-error" : ""}`}
      >
        {label}
      </label>
